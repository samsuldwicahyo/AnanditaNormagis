...
jsonSource_batas_0.addFeatures(features_batas_0);
var lyr_batas_0 = new ol.layer.Vector({
                declutter: false,
...
var format_SUNGAI_LN_25K_6 = new ol.format.GeoJSON();
var features_SUNGAI_LN_25K_6 = format_SUNGAI_LN_25K_6.readFeatures(json_SUNGAI_LN_25K_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SUNGAI_LN_25K_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SUNGAI_LN_25K_6.addFeatures(features_SUNGAI_LN_25K_6);
var lyr_SUNGAI_LN_25K_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SUNGAI_LN_25K_6, 
                style: style_SUNGAI_LN_25K_6,
                popuplayertitle: "SUNGAI_LN_25K",
                interactive: true,
                title: '<img src="styles/legend/SUNGAI_LN_25K_6.png" /> SUNGAI_LN_25K'
            });
var format_Jalanlengkapcopy_7 = new ol.format.GeoJSON();
var features_Jalanlengkapcopy_7 = format_Jalanlengkapcopy_7.readFeatures(json_Jalanlengkapcopy_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Jalanlengkapcopy_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Jalanlengkapcopy_7.addFeatures(features_Jalanlengkapcopy_7);
var lyr_Jalanlengkapcopy_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Jalanlengkapcopy_7, 
                style: style_Jalanlengkapcopy_7,
                popuplayertitle: "Jalan lengkap copy",
                interactive: true,
                title: '<img src="styles/legend/Jalanlengkapcopy_7.png" /> Jalan lengkap copy'
            });
...
var format_rumah_13 = new ol.format.GeoJSON();
var features_rumah_13 = format_rumah_13.readFeatures(json_rumah_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_rumah_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_rumah_13.addFeatures(features_rumah_13);
var lyr_rumah_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_rumah_13, 
                style: style_rumah_13,
                popuplayertitle: "rumah",
                interactive: true,
                title: '<img src="styles/legend/rumah_13.png" /> rumah'
            });
...
var format_PENDIDIKAN_PT_25K_15 = new ol.format.GeoJSON();
var features_PENDIDIKAN_PT_25K_15 = format_PENDIDIKAN_PT_25K_15.readFeatures(json_PENDIDIKAN_PT_25K_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PENDIDIKAN_PT_25K_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PENDIDIKAN_PT_25K_15.addFeatures(features_PENDIDIKAN_PT_25K_15);
var lyr_PENDIDIKAN_PT_25K_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PENDIDIKAN_PT_25K_15, 
                style: style_PENDIDIKAN_PT_25K_15,
                popuplayertitle: "PENDIDIKAN_PT_25K",
                interactive: true,
                title: '<img src="styles/legend/PENDIDIKAN_PT_25K_15.png" /> PENDIDIKAN_PT_25K'
            });
var format_BANGUNAN_PT_25K_16 = new ol.format.GeoJSON();
var features_BANGUNAN_PT_25K_16 = format_BANGUNAN_PT_25K_16.readFeatures(json_BANGUNAN_PT_25K_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BANGUNAN_PT_25K_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BANGUNAN_PT_25K_16.addFeatures(features_BANGUNAN_PT_25K_16);
var lyr_BANGUNAN_PT_25K_16 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BANGUNAN_PT_25K_16, 
                style: style_BANGUNAN_PT_25K_16,
                popuplayertitle: "BANGUNAN_PT_25K",
                interactive: true,
                title: '<img src="styles/legend/BANGUNAN_PT_25K_16.png" /> BANGUNAN_PT_25K'
            });

lyr_batas_0.setVisible(true);lyr_AGRIKEBUN_AR_25K_1.setVisible(true);lyr_AGRISAWAH_AR_25K_2.setVisible(true);lyr_PEMUKIMAN_AR_25K_3.setVisible(true);lyr_Bangunan_4.setVisible(true);lyr_point_5.setVisible(true);lyr_SUNGAI_LN_25K_6.setVisible(true);lyr_Jalanlengkapcopy_7.setVisible(true);lyr_JEMBATAN_PT_25K_8.setVisible(true);lyr_PEMERINTAHAN_PT_25K_9.setVisible(true);lyr_TAMBANGAN_PT_25K_10.setVisible(true);lyr_TONGGAKKM_PT_25K_11.setVisible(true);lyr_TOPONIMI_PT_25K_12.setVisible(true);lyr_rumah_13.setVisible(true);lyr_SARANAIBADAH_PT_25K_14.setVisible(true);lyr_PENDIDIKAN_PT_25K_15.setVisible(true);lyr_BANGUNAN_PT_25K_16.setVisible(true);
var layersList = [lyr_batas_0,lyr_AGRIKEBUN_AR_25K_1,lyr_AGRISAWAH_AR_25K_2,lyr_PEMUKIMAN_AR_25K_3,lyr_Bangunan_4,lyr_point_5,lyr_SUNGAI_LN_25K_6,lyr_Jalanlengkapcopy_7,lyr_JEMBATAN_PT_25K_8,lyr_PEMERINTAHAN_PT_25K_9,lyr_TAMBANGAN_PT_25K_10,lyr_TONGGAKKM_PT_25K_11,lyr_TOPONIMI_PT_25K_12,lyr_rumah_13,lyr_SARANAIBADAH_PT_25K_14,lyr_PENDIDIKAN_PT_25K_15,lyr_BANGUNAN_PT_25K_16];
lyr_batas_0.set('fieldAliases', {'id': 'id', });
...
lyr_point_5.set('fieldAliases', {'osm_id': 'osm_id', 'osm_type': 'osm_type', 'amenity': 'amenity', 'beds': 'beds', 'layer': 'layer', 'access_roo': 'access_roo', 'parking': 'parking', 'roof_mater': 'roof_mater', 'name': 'name', 'isced_leve': 'isced_leve', 'surface': 'surface', 'addr_house': 'addr_house', 'rooms': 'rooms', 'tunnel': 'tunnel', 'building_m': 'building_m', 'landuse': 'landuse', 'office': 'office', 'addr_stree': 'addr_stree', 'military': 'military', 'tourism': 'tourism', 'opening_ho': 'opening_ho', 'highway': 'highway', 'smoothness': 'smoothness', 'railway': 'railway', 'width': 'width', 'shop': 'shop', 'oneway': 'oneway', 'barrier': 'barrier', 'building': 'building', 'capacity': 'capacity', 'operator': 'operator', 'bridge': 'bridge', 'aeroway': 'aeroway', 'government': 'government', 'public_tra': 'public_tra', });
lyr_SUNGAI_LN_25K_6.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'nama': 'nama', });
lyr_Jalanlengkapcopy_7.set('fieldAliases', {'osm_id': 'osm_id', 'nama': 'nama', });
...
lyr_rumah_13.set('fieldAliases', {'id': 'id', 'n': 'n', });
...
lyr_PENDIDIKAN_PT_25K_15.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'LUAS': 'LUAS', 'KATPDK': 'KATPDK', 'JLPDDK': 'JLPDDK', 'FGGPDK': 'FGGPDK', 'REMARK': 'REMARK', 'FCODE': 'FCODE', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', 'JJGPDF': 'JJGPDF', 'JNSPDL': 'JNSPDL', });
lyr_BANGUNAN_PT_25K_16.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'FCODE': 'FCODE', 'REMARK': 'REMARK', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', });
lyr_batas_0.set('fieldImages', {'id': 'TextEdit', });
...
lyr_point_5.set('fieldImages', {'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'amenity': 'TextEdit', 'beds': 'TextEdit', 'layer': 'TextEdit', 'access_roo': 'TextEdit', 'parking': 'TextEdit', 'roof_mater': 'TextEdit', 'name': 'TextEdit', 'isced_leve': 'TextEdit', 'surface': 'TextEdit', 'addr_house': 'TextEdit', 'rooms': 'TextEdit', 'tunnel': 'TextEdit', 'building_m': 'TextEdit', 'landuse': 'TextEdit', 'office': 'TextEdit', 'addr_stree': 'TextEdit', 'military': 'TextEdit', 'tourism': 'TextEdit', 'opening_ho': 'TextEdit', 'highway': 'TextEdit', 'smoothness': 'TextEdit', 'railway': 'TextEdit', 'width': 'TextEdit', 'shop': 'TextEdit', 'oneway': 'TextEdit', 'barrier': 'TextEdit', 'building': 'TextEdit', 'capacity': 'TextEdit', 'operator': 'TextEdit', 'bridge': 'TextEdit', 'aeroway': 'TextEdit', 'government': 'TextEdit', 'public_tra': 'TextEdit', });
lyr_SUNGAI_LN_25K_6.set('fieldImages', {'NAMOBJ': 'TextEdit', 'nama': 'TextEdit', });
lyr_Jalanlengkapcopy_7.set('fieldImages', {'osm_id': 'TextEdit', 'nama': 'TextEdit', });
...
lyr_rumah_13.set('fieldImages', {'id': 'TextEdit', 'n': 'TextEdit', });
lyr_SARANAIBADAH_PT_25K_14.set('fieldImages', {'NAMOBJ': 'TextEdit', 'LUAS': 'TextEdit', 'FGSIBD': 'TextEdit', 'FCODE': 'TextEdit', 'REMARK': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', });
lyr_PENDIDIKAN_PT_25K_15.set('fieldImages', {'NAMOBJ': 'TextEdit', 'LUAS': 'TextEdit', 'KATPDK': 'TextEdit', 'JLPDDK': 'TextEdit', 'FGGPDK': 'TextEdit', 'REMARK': 'TextEdit', 'FCODE': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', 'JJGPDF': 'TextEdit', 'JNSPDL': 'TextEdit', });
lyr_BANGUNAN_PT_25K_16.set('fieldImages', {'NAMOBJ': 'TextEdit', 'FCODE': 'TextEdit', 'REMARK': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', });
lyr_batas_0.set('fieldLabels', {'id': 'no label', });
...
lyr_point_5.set('fieldLabels', {'osm_id': 'no label', 'osm_type': 'no label', 'amenity': 'no label', 'beds': 'no label', 'layer': 'no label', 'access_roo': 'no label', 'parking': 'no label', 'roof_mater': 'no label', 'name': 'no label', 'isced_leve': 'no label', 'surface': 'no label', 'addr_house': 'no label', 'rooms': 'no label', 'tunnel': 'no label', 'building_m': 'no label', 'landuse': 'no label', 'office': 'no label', 'addr_stree': 'no label', 'military': 'no label', 'tourism': 'no label', 'opening_ho': 'no label', 'highway': 'no label', 'smoothness': 'no label', 'railway': 'no label', 'width': 'no label', 'shop': 'no label', 'oneway': 'no label', 'barrier': 'no label', 'building': 'no label', 'capacity': 'no label', 'operator': 'no label', 'bridge': 'no label', 'aeroway': 'no label', 'government': 'no label', 'public_tra': 'no label', });
lyr_SUNGAI_LN_25K_6.set('fieldLabels', {'NAMOBJ': 'no label', 'nama': 'no label', });
lyr_Jalanlengkapcopy_7.set('fieldLabels', {'osm_id': 'no label', 'nama': 'inline label - visible with data', });
...
lyr_rumah_13.set('fieldLabels', {'id': 'no label', 'n': 'no label', });
...
lyr_PENDIDIKAN_PT_25K_15.set('fieldLabels', {'NAMOBJ': 'no label', 'LUAS': 'no label', 'KATPDK': 'no label', 'JLPDDK': 'no label', 'FGGPDK': 'no label', 'REMARK': 'no label', 'FCODE': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'JJGPDF': 'no label', 'JNSPDL': 'no label', });
lyr_BANGUNAN_PT_25K_16.set('fieldLabels', {'NAMOBJ': 'no label', 'FCODE': 'no label', 'REMARK': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', });
lyr_BANGUNAN_PT_25K_16.on('precompose', function(evt) {
